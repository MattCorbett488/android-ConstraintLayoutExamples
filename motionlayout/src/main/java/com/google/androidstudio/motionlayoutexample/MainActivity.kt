...
class MainActivity : AppCompatActivity(), CompoundButton.OnCheckedChangeListener {
    ...
    private val myDataset: Array<DemosAdapter.Demo> = arrayOf(
            ...
            DemosAdapter.Demo("ImageFilterView Saturation/Warmth/Contrast Example", "Showing Saturation, Warmth and Contrast effects in ImageFilterView", R.layout.motion_imagefilterview),
