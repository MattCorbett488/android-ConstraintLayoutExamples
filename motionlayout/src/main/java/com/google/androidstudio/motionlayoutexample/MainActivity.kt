...
class MainActivity : AppCompatActivity(), CompoundButton.OnCheckedChangeListener {
    ...
    private val myDataset: Array<DemosAdapter.Demo> = arrayOf(
            ...
            DemosAdapter.Demo("OnClick Example", "Basic example showing the OnClick tag", R.layout.motion_onclick),
            ...
            DemosAdapter.Demo("ImageFilterView Saturation/Warmth Example", "Showing Saturation and Warmth effects in ImageFilterView", R.layout.motion_imagefilterview),
            DemosAdapter.Demo("ImageFilterView Contrast Example", "Showing Contrast in ImageFilterView", R.layout.motion_imagefilterview_contrast),
